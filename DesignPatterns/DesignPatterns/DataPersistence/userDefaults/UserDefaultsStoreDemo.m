...
- (IBAction)readBasic:(UIButton *)sender
{
    ...
    switch (self.basicDataStype.selectedSegmentIndex)
    {
        ...
        case 2: // integer
        {
            ...
            [self alertWithTitle:@"读取数据成功" message:[NSString stringWithFormat:@"integer数据为%lu",integer]];
        }
            break;
        case 3: // double
        {
...
- (IBAction)objectRead:(UIButton *)sender
{
    ...
    [self alertWithTitle:@"读取成功" message:[NSString stringWithFormat:@"人数为：%lu",array.count]];
