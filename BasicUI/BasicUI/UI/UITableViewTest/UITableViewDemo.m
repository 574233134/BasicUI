...
@interface UITableViewDemo ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)loadData
{
    self.dataArray = [NSArray arrayWithObjects:
                      @"SystemCellStylePresentationViewController",
                      @"TableViewAddAction",
                      @"TableViewDeleteAction",
                      @"TableViewSelectAction",
                      @"TableViewMoveAction",
                      @"TableIndexViewController",
                      @"TableViewDragAction",
                      @"TableViewRefreashDemo",
                      nil];
}
